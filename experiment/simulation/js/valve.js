...
function dataSheet() {
  //console.log(d);
  for (var i = 0; i < 3; i++) {
    if (i == 0) document.getElementById("dt" + r + "m" + (i + 1)).innerHTML = 0;
    else if (i == 1)
      document.getElementById("dt" + r + "m" + 2).innerHTML = finalht.toFixed(
        4
      );
    else document.getElementById("dt" + r + "m" + (i + 1)).innerHTML = 30;
  }
  //console.log(finalht);
